...
function Aseguradoras() {
  ...
  const obtenerAseguradoras = async () => {
    const respuesta = await axios.get('http://192.168.100.66:3001/aseguradoras')
  ...
  const guardar = async (e) => {
    e.preventDefault()
    if (editando) {
      await axios.put(`http://192.168.100.66:3001/aseguradoras/${editando}`, formulario)
      setEditando(null)
    } else {
      await axios.post('http://192.168.100.66:3001/aseguradoras', formulario)
    }
  ...
  const eliminar = async (id) => {
    await axios.delete(`http://192.168.100.66:3001/aseguradoras/${id}`)
    obtenerAseguradoras()
  }
