...
function Ordenes() {
  ...
  const obtenerVehiculos = async () => {
    const respuesta = await axios.get('http://192.168.100.66:3001/vehiculos')
    setVehiculos(respuesta.data)
  }

  const obtenerEmpleados = async () => {
    const respuesta = await axios.get('http://192.168.100.66:3001/empleados')
  ...
  const agregarOrden = async (e) => {
    e.preventDefault()
    await axios.post('http://192.168.100.66:3001/ordenes', formulario)
...
const cambiarEstado = async (id, estado) => {
    ...
    await axios.patch(`http://192.168.100.66:3001/ordenes/${id}/estado`, { estado })
  ...
  const eliminarOrden = async (id) => {
    await axios.delete(`http://192.168.100.66:3001/ordenes/${id}`)
    obtenerOrdenes()
  }
