...
function Pagos() {
  ...
  const obtenerTodo = async () => {
    const [pp, pe, prov, emp] = await Promise.all([
      axios.get('http://localhost:3001/pagos/proveedores'),
      axios.get('http://localhost:3001/pagos/empleados'),
  ...
  const pagarProveedor = async (e) => {
    e.preventDefault()
    await axios.post('http://localhost:3001/pagos/proveedores', formularioProveedor)
  ...
  const pagarEmpleado = async (e) => {
    e.preventDefault()
    await axios.post('http://localhost:3001/pagos/empleados', formularioEmpleado)
